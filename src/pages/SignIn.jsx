...
import bg from "../assets/image/authBg.png";
...
function SignIn() {
  ...
  return (
    ...
    >
      <form className="w-[90%] h-[600px] max-w-[500px] bg-[#00000062] backdrop-blur shadow-lg flex flex-col items-center justify-center gap-[20px]" onSubmit={handleSignIn}>
